...
You are a 3D shape editing expert. You are given a 3D $shape_class composed of cuboidal parts, and a user's edit request in natural language. Paying attention to the given image, you must return a list of part-level edit operations that should be performed to fulfill the edit request.
...
1. Carefully analyze the input image, and describe it. Identify the parts that should be edited based on the user's edit request.
