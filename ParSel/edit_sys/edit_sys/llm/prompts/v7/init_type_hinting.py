...
3. **Correct Type Hints**: Shortening/Lengthening/Thickening/Thinning/Contracting/Expanding implies 'scale' type. Move/shift/slide/translate implies 'translate' type. Rotate/turn implies 'rotate' type. Tilt/lean implies 'shear' type. Please carefully evaluate the edit request to determine the correct type hints. 

4. **Face/Edge Movement**: If the edit request specifies movement of a face or an edge, the type hint should be 'scale' or 'shear' based on the context. 
