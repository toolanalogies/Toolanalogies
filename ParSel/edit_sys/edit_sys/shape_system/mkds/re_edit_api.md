...
DIRECTION_STRINGS = ["front", "back", "left", "right", "up", "down", "messi4"]
...
class Part:
    ...
    def get(self, label: str) -> Part:
        ...
        Parameters:
        label (str): The full name of the sub-part.
        ...
        Example:
            >>> shape = Part(...)
            >>> leg_part = shape.get("legs/leg_front_right")
        """

    def get_relation(self, label: str) -> Relation:
        """
        Retrieve the symmetry relation encapsulated in the part with the given label.

        Parameters:
        label (str): The full name of the sub-part.

        Returns:
        Relation: The (translation or rotational symmetry) relation inside the sub-part.

        Example:
            >>> # A chair with back vertical bars containing a translation symmetry. 
            >>> # To access the symmetry relation, use:
            >>> relation = seat.get_relation("back_vertical_bars")
        """
...
class Translate:
    ...
    amount_from_operand (Part|None): The amount of translation applied to the operand will be the same as the amount applied to amount_from_operand.
